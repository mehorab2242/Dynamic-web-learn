            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" class="rounded-md px-3 py-2 text-sm font-medium <?php echo $current == 'index.php' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?>">Home</a>

                        <a href="/about.php" class="rounded-md px-3 py-2 text-sm font-medium <?php echo $current == 'about.php' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?>">About</a>

                        <a href="/contact.php" class="rounded-md px-3 py-2 text-sm font-medium <?php echo $current == 'contact.php' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?>">Contact</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
